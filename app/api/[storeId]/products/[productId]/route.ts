...
export async function PATCH(
  ...
  try {
    ...
    if (!params.productId) {
      return new NextResponse("Id de produto é necessário", { status: 400 });
    }
    ...
    if (!categoryId) {
      return new NextResponse("Id de categoria é necessário", { status: 400 });
    }

    if (!colorId) {
      return new NextResponse("Id de cor é necessário", { status: 400 });
    }

    if (!sizeId) {
      return new NextResponse("Id de tamanho é necessário", { status: 400 });
    }
